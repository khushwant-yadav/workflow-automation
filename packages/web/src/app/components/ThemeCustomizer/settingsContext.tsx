...
export const SettingsProvider = ({ children }: Props) => {
  ...
  useEffect(() => {
    ...
    const modeStyles =
      settings.theme.styles?.[modeKey] || settings.theme.styles?.light;
  ...
  const hasStateChanged = () => {
    return (
      JSON.stringify(settings.theme.styles) !==
      JSON.stringify(initialSettings.theme.styles)
    );
  };
